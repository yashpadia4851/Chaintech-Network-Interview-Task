...
const EyeIcon = () => (
  <svg className="size-4 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
      ...
      <div className="relative">
        ...
        {isPassword && (
          <button
            ...
            className="absolute right-2 top-1/2 -translate-y-1/2 rounded p-1 hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-slate-400"
            tabIndex={-1}
